...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty vibrateOnDown;
    private SerializedProperty vibrateDuration;
    ...
    protected virtual void OnEnable()
    {
        ...
        vibrateOnDown = serializedObject.FindProperty("vibrateOnDown");
        vibrateDuration = serializedObject.FindProperty("vibrateDuration");
    }
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(vibrateOnDown, new GUIContent("VibrateOnDown", "Only work on Android."));
        EditorGUILayout.PropertyField(vibrateDuration, new GUIContent("VibrateDuration", "Only work on Android."));
    }
