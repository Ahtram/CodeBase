...
<root>
  ...
  ├── Editor
  │   ├── Teamuni.Codebase.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Teamuni.Codebase.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Teamuni.Codebase.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Teamuni.Codebase.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Teamuni.Codebase`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package CodeBase Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Teamuni.Codebase.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Teamuni.Codebase.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Teamuni.Codebase.Editor.Tests.asmdef`

  `Tests/Runtime/Teamuni.Codebase.Tests.asmdef`
...
Use the `Documentations~/CodeBase.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
